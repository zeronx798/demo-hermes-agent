...
function spotifySrc(embedUrl, isDark) {
...
export default function SpotifyEmbedRenderer({ descriptor }) {
    ...
    return (_jsx("iframe", { allow: ALLOW, className: "block w-full border-0 bg-transparent", loading: "lazy", src: src, style: style, title: "Spotify embed" }));
}
