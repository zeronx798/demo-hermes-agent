...
const OUTLINE = [78, 66, 58];
const SHADOW = [214, 198, 168];
const HIGHLIGHT = [253, 249, 238];
...
export function PixelEggSprite({ mode, size, index = 0, className, style, onDone }) {
    ...
    return (_jsx("canvas", { className: className, ref: canvasRef, style: { width: size, height: size, imageRendering: 'pixelated', ...style } }));
}
