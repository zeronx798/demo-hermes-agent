...
export const PAUSE_DWELL = { maxMs: 13000, meanMs: 4200, minMs: 1500 };
 ...
 */
export function dwellMs({ meanMs, minMs, maxMs }, rng = Math.random) {
 ...
 */
export function chooseMove(canHop, rng = Math.random) {
    if (rng() < REST_CHANCE) {
        return 'rest';
    }
 ...
 */
export function pickStrollTarget(ledge, fromX, rng = Math.random) {
