 ...
 */
export function TerminalOutput({ className, text }) {
    ...
    return (_jsx("div", { className: cn('max-h-16 overflow-auto overscroll-contain', className), "data-selectable-text": "true", ref: ref, children: _jsx("pre", { className: "w-max min-w-full font-mono text-[0.5625rem] leading-[0.85rem] whitespace-pre text-muted-foreground/70", children: text }) }));
}
