...
export function installVscodeThemeFromText(text, opts) {
 ...
 */
export function buildThemeFromMarketplace(result) {
 ...
 */
export async function installVscodeThemeFromMarketplace(id) {
