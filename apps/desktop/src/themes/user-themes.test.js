...
import { $marketplaceInstalls, $userThemes, installUserTheme, isUserTheme, listAllThemes, marketplaceIdOf, removeUserTheme, resolveTheme } from './user-themes';
import { convertVscodeColorTheme } from './vscode';
const makeTheme = (label, source) => convertVscodeColorTheme({
    name: label,
    type: 'dark',
    colors: { 'editor.background': '#101014', 'editor.foreground': '#fafafa', focusBorder: '#7aa2f7' }
}, source ? { source } : undefined).theme;
