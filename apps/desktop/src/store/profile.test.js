...
const $gateway = atom({ id: 'live-socket' });
...
const profile = (name, isDefault = false) => ({
    has_env: false,
...
const remoteConn = (over = {}) => ({ baseUrl: 'https://hermes-roy.tail.ts.net', mode: 'remote', profile: 'vps-remote', ...over });
const localConn = (over = {}) => ({ baseUrl: '', mode: 'local', profile: 'default', ...over });
