...
export const $starmapGraph = atom(null);
export const $starmapLoading = atom(false);
export const $starmapError = atom(null);
let inflight = null;
export async function loadStarmapGraph(force = false) {
    if (inflight) {
        return inflight;
    }
...
export function evictStarmapNode(id) {
...
export function resetStarmapGraph() {
    inflight = null;
