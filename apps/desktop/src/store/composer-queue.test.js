...
import { $queuedPromptsBySession, clearQueuedPrompts, dequeueQueuedPrompt, enqueueQueuedPrompt, getQueuedPrompts, migrateQueuedPrompts, promoteQueuedPrompt, removeQueuedPrompt, shouldAutoDrain, updateQueuedPrompt, updateQueuedPromptText } from './composer-queue';
...
describe('composer queue store', () => {
    ...
    it('updates queued text and attachment snapshot', () => {
        ...
        expect(first).not.toBeNull();
        expect(updateQueuedPrompt(SESSION_KEY, first.id, {
