...
export const setThreadAtBottom = (isAtBottom) => {
...
export const onScrollToBottomRequest = (handler) => {
...
const editOpenHandlers = new Set();
const editCloseHandlers = new Set();
export const onThreadEditOpen = (handler) => {
...
export const onThreadEditClose = (handler) => {
