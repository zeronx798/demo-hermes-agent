...
import { $perSessionBrowse, browseBackward, browseForward, deriveUserHistory, isBrowsingHistory, resetBrowseState } from './composer-input-history';
const SESSION_A = 'session-a';
const SESSION_B = 'session-b';
// Newest-first user text ring, what the caller passes to browse*.
const HISTORY = ['third', 'second', 'first'];
const MSG = (role, text) => ({ id: '', role, text });
beforeEach(() => {
