...
import { $composerAttachments, addComposerAttachment, clearSessionDraft, removeComposerAttachment, SESSION_DRAFTS_STORAGE_KEY, stashSessionDraft, takeSessionDraft, updateComposerAttachment } from './composer';
...
describe('session drafts', () => {
    ...
    it('persists draft text (not attachments) to localStorage', () => {
        ...
        const persisted = JSON.parse(window.localStorage.getItem(SESSION_DRAFTS_STORAGE_KEY) ?? '{}');
