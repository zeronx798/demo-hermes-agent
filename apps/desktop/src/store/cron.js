...
export const setCronJobs = (jobs) => $cronJobs.set(jobs);
...
export const updateCronJobs = (fn) => $cronJobs.set(fn($cronJobs.get()));
...
export const $cronFocusJobId = atom(null);
export const setCronFocusJobId = (id) => $cronFocusJobId.set(id);
