...
let secondaryWindowCache = null;
export function isSecondaryWindow() {
...
let newSessionWindowCache = null;
export function isNewSessionWindow() {
...
export function canOpenSessionWindow() {
...
async function openWindow(call, failMessage) {
    try {
...
export async function openSessionInNewWindow(sessionId, opts) {
...
export async function openNewSessionInNewWindow() {
