...
// installed map.
export const HUB_SOURCES_KEY = ['skill-hub-sources'];
...
const SKILLS_LIST_KEY = ['skills-list'];
...
async function runHubAction(key, kind, spawn) {
