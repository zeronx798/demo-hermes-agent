...
function cacheKey(displayMode, value) {
 ...
 */
function renderMath(value, displayMode, errorColor, file, element) {
    let html;
    try {
 ...
 */
function createMemoizedRehypeKatex(options = {}) {
 ...
 */
export function createMemoizedMathPlugin(config = {}) {
    const remarkPlugin = [remarkMath, { singleDollarTextMath: config.singleDollarTextMath ?? false }];
