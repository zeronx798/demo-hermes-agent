...
export function localPreviewTarget(rawTarget, cwd) {
...
async function enrichPreviewTarget(target) {
...
export async function normalizeOrLocalPreviewTarget(rawTarget, cwd) {
    try {
