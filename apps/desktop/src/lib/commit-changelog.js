...
const FALLBACK_GROUP = { id: 'other', items: ['Improvements and fixes'], label: 'In this update' };
...
export function parseCommitHeader(raw) {
 ...
 */
export function buildCommitChangelog(commits, options = {}) {
