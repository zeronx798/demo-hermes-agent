...
export function mediaName(path) {
    try {
...
export function mediaMarkdownHref(path) {
...
export function mediaExternalUrl(path) {
...
export function mediaPathFromMarkdownHref(href) {
...
export function filePathFromMediaPath(path) {
...
export async function gatewayMediaDataUrl(path) {
...
export async function downloadGatewayMediaFile(path) {
...
export function mediaDisplayLabel(path) {
