...
vi.mock('@/hermes', () => ({
    getGlobalModelOptions: (...args) => getGlobalModelOptions(...args)
}));
...
function renderPanel(onSelectModel = vi.fn()) {
    ...
    render(_jsx(QueryClientProvider, { client: client, children: _jsx(DropdownMenu, { open: true, children: _jsx(DropdownMenuContent, { children: _jsx(ModelMenuPanel, { onSelectModel: onSelectModel, requestGateway: vi.fn() }) }) }) }));
