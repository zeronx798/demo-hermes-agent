...
vi.mock('@/hermes', () => ({
    ...
    setModelAssignment: (body) => setModelAssignment(body),
    getRecommendedDefaultModel: (slug) => getRecommendedDefaultModel(slug),
...
describe('ModelSettings', () => {
    ...
    it('writes the profile default speed (service_tier) when the fast switch is toggled', async () => {
        ...
        await waitFor(() => expect(saveHermesConfig).toHaveBeenCalledWith(expect.objectContaining({ agent: expect.objectContaining({ service_tier: 'fast' }) })));
    });
