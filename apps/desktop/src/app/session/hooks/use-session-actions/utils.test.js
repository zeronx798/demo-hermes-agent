...
import { chatMessageArraysEquivalent, isSessionGoneError, reconcileResumeMessages, sessionMatchesStoredId, sessionShouldHaveTranscript, toBranchMessages } from './utils';
const msg = (id, role, text, extra = {}) => ({ id, role, parts: [{ type: 'text', text }], ...extra });
const session = (over) => over;
