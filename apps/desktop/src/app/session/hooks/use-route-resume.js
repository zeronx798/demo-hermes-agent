...
function rawHashLooksLikeSession() {
...
export function useRouteResume({ activeSessionId, activeSessionIdRef, creatingSessionRef, currentView, freshDraftReady, gatewayState, locationPathname, resumeSession, resumeFailedSessionId, resumeExhaustedSessionId, routedSessionId, runtimeIdByStoredSessionIdRef, selectedStoredSessionId, selectedStoredSessionIdRef, startFreshSessionDraft }) {
    ...
    useEffect(() => {
        ...
        if (routedSessionId) {
            ...
            const alreadyActive = routedSessionId === selectedStoredSessionIdRef.current &&
        ...
        if (isNewChatRoute(locationPathname) &&
    ...
    useEffect(() => {
        ...
        const stranded = Boolean(routedSessionId) && resumeFailedSessionId === routedSessionId && !creatingSessionRef.current;
        if (!stranded) {
