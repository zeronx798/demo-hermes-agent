...
function Harness({ busyRef, onReady, onSeedState, openMemoryGraph, refreshSessions, requestGateway, resumeStoredSession, seedMessages, storedSessionId, activeSessionId, createBackendSessionForSend }) {
    const activeSessionIdRef = {
        current: activeSessionId === undefined ? RUNTIME_SESSION_ID : activeSessionId
    };
    const selectedStoredSessionIdRef = {
