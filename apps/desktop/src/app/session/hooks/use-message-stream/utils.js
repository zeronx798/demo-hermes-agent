...
export function sessionInfoStatePatch(payload) {
    const patch = {};
...
export function hasSessionInfoStatePatch(patch) {
...
export function completionErrorText(finalText) {
...
export function toTodoPayload(payload) {
    if (!payload) {
        return undefined;
    }
...
function parseMaybeRecord(value) {
...
export function delegateTaskPayloads(payload, phase, sourceEventType) {
    ...
    return tasks.map((task, index) => {
        ...
        return {
            ...
            output_tail: phase === 'complete' && summary
