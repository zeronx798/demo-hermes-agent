...
export function useCwdActions({ activeSessionId, activeSessionIdRef, onSessionRuntimeInfo, requestGateway }) {
    const { t } = useI18n();
    const copy = t.desktop;
    const refreshProjectBranch = useCallback(async (cwd) => {
    ...
    const changeSessionCwd = useCallback(async (cwd) => {
