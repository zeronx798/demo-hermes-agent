...
import { dragHasAttachments, droppedFileInlineRefs } from '../inline-refs';
/**
 ...
 */
export function useComposerDrop({ cwd, insertInlineRefs, onAttachDroppedItems, requestMainFocus }) {
    ...
    const handleInputDragOver = (event) => {
