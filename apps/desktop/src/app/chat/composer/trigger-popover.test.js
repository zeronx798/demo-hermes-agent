...
function renderPopover(kind, loading = false) {
    const onHover = vi.fn();
    const onPick = vi.fn();
    const rendered = render(_jsx(I18nProvider, { configClient: null, initialLocale: "zh", children: _jsx(ComposerTriggerPopover, { activeIndex: 0, items: [], kind: kind, loading: loading, onHover: onHover, onPick: onPick }) }));
