...
describe('PreviewPane console state', () => {
    ...
    it('does not watch backend-only remote filesystem previews locally', () => {
        ...
        render(_jsx(PreviewPane, { setTitlebarToolGroup: vi.fn(), target: {
                kind: 'file',
                label: 'file.txt',
    ...
    it('does not rebuild the pane titlebar group for streamed console logs', () => {
        ...
        const rendered = render(_jsx(PreviewPane, { setTitlebarToolGroup: setTitlebarToolGroup, target: {
                kind: 'url',
                label: 'Preview',
        ...
        act(() => {
            webview?.dispatchEvent(Object.assign(new Event('console-message'), {
                level: 0,
