...
export function ReorderableList({ children, ids, onReorder, sensors }) {
    const handleDragEnd = ({ activatorEvent, active, over }) => {
    ...
    return (_jsx(DndContext, { autoScroll: reorderAutoScroll, collisionDetection: closestCenter, onDragEnd: handleDragEnd, sensors: sensors, children: _jsx(SortableContext, { items: ids, strategy: verticalListSortingStrategy, children: children }) }));
}
export function useSortableBindings(id) {
