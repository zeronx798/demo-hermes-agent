...
function cleanReviveSnapshot(serialized) {
    const visible = (line) => stripEscapeSequences(line).replace(/[\s%]/g, '');
...
export function useTerminalSession({ id, cwd, active, onAddSelectionToChat, reviveBuffer, onShell }) {
