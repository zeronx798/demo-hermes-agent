...
const commandHeaders = new Map();
const lastSnapshots = new Map();
const seededCommands = new Set();
...
export function registerAgentTerminalWriter(procId, write) {
...
export function writeAgentTerminalChunk(procId, chunk) {
    if (!procId || !chunk) {
        return;
    }
...
export function seedAgentTerminalCommand(procId, command) {
...
export function syncAgentTerminalSnapshot(procId, output) {
    if (!procId || !output) {
        return;
    }
