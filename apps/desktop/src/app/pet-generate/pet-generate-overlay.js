...
import { $petGenDrafts, $petGenerateOpen, $petGenError, $petGenStatus, cleanupPetGenOnClose, closePetGenerate } from '@/store/pet-generate';
    ...
    const banner = errored
        ...
        : working
            ...
            : stepOne
                ...
                : undefined;
    return (_jsx(Dialog, { onOpenChange: handleOpenChange, open: open, children: _jsx(DialogContent, { "aria-describedby": undefined, banner: banner, bannerTone: errored ? 'error' : 'info', 
            ...
            className: cn('gap-4 text-center', single ? 'min-w-[17rem] max-w-[20rem]' : 'min-w-[19rem] max-w-[22rem]'), fitContent: true, children: open && _jsx(PetGenerateContent, {}) }) }));
}
